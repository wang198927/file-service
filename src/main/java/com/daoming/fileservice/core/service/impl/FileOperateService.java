...
public class FileOperateService implements IFileOperateService {
    ...
    @Override
    public void uploadFile(String fileName, byte[] byteArray) {
        try {
            ...
            minioClient.putObject("createtest", fileName, stream, stream.available(), "application/octet-stream");
    ...
    public byte[] downloadFile(String fileName) {
        try {
            InputStream stream = minioClient.getObject("createtest", fileName);
